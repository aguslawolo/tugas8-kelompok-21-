...
public class AdapterResep extends RecyclerView.Adapter<AdapterResep.MyHolder> {
    ...
    public AdapterResep.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view_resep,
                parent, false);
        return new MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterResep.MyHolder holder, int position) {
    // set data
